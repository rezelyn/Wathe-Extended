...
public class WatheExtendedBlocks {
    ...
    public static final Block ANTHRACITE_STEEL_ORNAMENT = register("anthracite_steel_ornament", new OrnamentBlock(AbstractBlock.Settings.create().nonOpaque().noCollision().strength(0.25f).sounds(BlockSoundGroup.COPPER)));
    public static final Block KHAKI_STEEL_ORNAMENT = register("khaki_steel_ornament", new OrnamentBlock(AbstractBlock.Settings.create().nonOpaque().noCollision().strength(0.25f).sounds(BlockSoundGroup.COPPER)));
    public static final Block MAROON_STEEL_ORNAMENT = register("maroon_steel_ornament", new OrnamentBlock(AbstractBlock.Settings.create().nonOpaque().noCollision().strength(0.25f).sounds(BlockSoundGroup.COPPER)));
    public static final Block MUNTZ_STEEL_ORNAMENT = register("muntz_steel_ornament", new OrnamentBlock(AbstractBlock.Settings.create().nonOpaque().noCollision().strength(0.25f).sounds(BlockSoundGroup.COPPER)));
    public static final Block NAVY_STEEL_ORNAMENT = register("navy_steel_ornament", new OrnamentBlock(AbstractBlock.Settings.create().nonOpaque().noCollision().strength(0.25f).sounds(BlockSoundGroup.COPPER)));
    ...
    public static final Block MUSIC_DISC_BOX = register("music_disc_box", new MusicDiscBoxBlock(AbstractBlock.Settings.create().nonOpaque().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block PIZZA = register("pizza", new PizzaBlock(AbstractBlock.Settings.create().nonOpaque().strength(0.5f).sounds(BlockSoundGroup.MUD)));
    ...
    public static void initialize() {
        ItemGroupEvents.modifyEntriesEvent(WatheItems.DECORATION_GROUP).register(entries -> entries.addAfter(WatheBlocks.GOLD_ORNAMENT, ANTHRACITE_STEEL_ORNAMENT, KHAKI_STEEL_ORNAMENT, MAROON_STEEL_ORNAMENT, MUNTZ_STEEL_ORNAMENT, NAVY_STEEL_ORNAMENT));
        ItemGroupEvents.modifyEntriesEvent(WatheItems.BUILDING_GROUP).register(entries -> entries.addAfter(WatheBlocks.MARBLE_SLAB, MARBLE_PANEL));
        ItemGroupEvents.modifyEntriesEvent(WatheItems.BUILDING_GROUP).register(entries -> entries.addAfter(WatheBlocks.DARK_MARBLE_SLAB, DARK_MARBLE_PANEL));
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.NATURAL).register(entries -> entries.addAfter(Items.FLOWERING_AZALEA_LEAVES, SNOWY_OAK_LEAVES, SNOWY_SPRUCE_LEAVES, SNOWY_BIRCH_LEAVES, SNOWY_JUNGLE_LEAVES, SNOWY_ACACIA_LEAVES, SNOWY_DARK_OAK_LEAVES, SNOWY_MANGROVE_LEAVES, SNOWY_CHERRY_LEAVES, SNOWY_AZALEA_LEAVES, SNOWY_FLOWERING_AZALEA_LEAVES));
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.FOOD_AND_DRINK).register(entries -> entries.addAfter(Items.CAKE, PIZZA));
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.FUNCTIONAL).register(entries -> entries.addAfter(RatatouilleBlocks.MAUVE_PLUSH, ISH_PLUSH));
    }
}
