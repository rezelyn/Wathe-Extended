...
public class ItemsCategory {
    ...
    public static ConfigCategory build(Screen parent, BiConsumer<String, Screen> sendCommand) {
        ...
        builder.option(Option.<Integer>createBuilder()
                .name(Text.translatable("gui.watheextended.config.category.items.price"))
                .description(OptionDescription.of(Text.translatable("gui.watheextended.config.category.items.opt.knife.price")))
                .binding(100, () -> ClientConfig.getInt("watheextended.knife.price", 100), value -> stage(sendCommand, parent, "watheextended.knife.price", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        /// COOLDOWN
        builder.option(Option.<Integer>createBuilder()
                .name(Text.translatable("gui.watheextended.config.category.items.cooldown"))
                .description(OptionDescription.of(Text.translatable("gui.watheextended.config.category.items.opt.knife.cooldown")))
                .binding(60, () -> ClientConfig.getInt("watheextended.knife.cooldown", 60), value -> stage(sendCommand, parent, "watheextended.knife.cooldown", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        ...
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(300, () -> ClientConfig.getInt("watheextended.revolver.price", 300), value -> stage(sendCommand, parent, "watheextended.revolver.price", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        /// COOLDOWN
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(10, () -> ClientConfig.getInt("watheextended.revolver.cooldown", 10), value -> stage(sendCommand, parent, "watheextended.revolver.cooldown", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        ...
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(350, () -> ClientConfig.getInt("watheextended.grenade.price", 350), value -> stage(sendCommand, parent, "watheextended.grenade.price", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        /// COOLDOWN
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(90, () -> ClientConfig.getInt("watheextended.grenade.cooldown", 90), value -> stage(sendCommand, parent, "watheextended.grenade.cooldown", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        ...
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(300, () -> ClientConfig.getInt("watheextended.psychoMode.price", 300), value -> stage(sendCommand, parent, "watheextended.psychoMode.price", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        /// COOLDOWN
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(300, () -> ClientConfig.getInt("watheextended.psychoMode.cooldown", 300), value -> stage(sendCommand, parent, "watheextended.psychoMode.cooldown", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        ...
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(50, () -> ClientConfig.getInt("watheextended.lockpick.price", 50), value -> stage(sendCommand, parent, "watheextended.lockpick.price", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        /// COOLDOWN
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(180, () -> ClientConfig.getInt("watheextended.lockpick.cooldown", 180), value -> stage(sendCommand, parent, "watheextended.lockpick.cooldown", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        ...
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(25, () -> ClientConfig.getInt("watheextended.crowbar.price", 25), value -> stage(sendCommand, parent, "watheextended.crowbar.price", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        /// COOLDOWN
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(10, () -> ClientConfig.getInt("watheextended.crowbar.cooldown", 10), value -> stage(sendCommand, parent, "watheextended.crowbar.cooldown", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        ...
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(200, () -> ClientConfig.getInt("watheextended.bodyBag.price", 200), value -> stage(sendCommand, parent, "watheextended.bodyBag.price", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        /// COOLDOWN
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(300, () -> ClientConfig.getInt("watheextended.bodyBag.cooldown", 300), value -> stage(sendCommand, parent, "watheextended.bodyBag.cooldown", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        ...
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(200, () -> ClientConfig.getInt("watheextended.blackout.price", 200), value -> stage(sendCommand, parent, "watheextended.blackout.price", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        /// COOLDOWN
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(300, () -> ClientConfig.getInt("watheextended.blackout.cooldown", 300), value -> stage(sendCommand, parent, "watheextended.blackout.cooldown", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        ...
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(100, () -> ClientConfig.getInt("watheextended.poisonVial.price", 100), value -> stage(sendCommand, parent, "watheextended.poisonVial.price", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        ...
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(50, () -> ClientConfig.getInt("watheextended.scorpion.price", 50), value -> stage(sendCommand, parent, "watheextended.scorpion.price", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        ...
        builder.option(Option.<Integer>createBuilder()
                ...
                .binding(10, () -> ClientConfig.getInt("watheextended.firecracker.price", 10), value -> stage(sendCommand, parent, "watheextended.firecracker.price", value))
                .controller(IntegerFieldControllerBuilder::create)
                .build());
        ...
        if (cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.isLoaded()) {
            ...
            builder.option(Option.<Integer>createBuilder()
                    ...
                    .binding(60, () -> ClientConfig.getInt("watheextended.sulfuricAcidBarrel.cooldown", 60), value -> stage(sendCommand, parent, "watheextended.sulfuricAcidBarrel.cooldown", value))
                    .controller(IntegerFieldControllerBuilder::create)
                    .build());
            ...
            builder.option(Option.<Integer>createBuilder()
                    ...
                    .binding(100, () -> ClientConfig.getInt("watheextended.huntingKnife.price", 100), value -> stage(sendCommand, parent, "watheextended.huntingKnife.price", value))
                    .controller(IntegerFieldControllerBuilder::create)
                    .build());
            /// COOLDOWN
            builder.option(Option.<Integer>createBuilder()
                    ...
                    .binding(45, () -> ClientConfig.getInt("watheextended.huntingKnife.cooldown", 45), value -> stage(sendCommand, parent, "watheextended.huntingKnife.cooldown", value))
                    .controller(IntegerFieldControllerBuilder::create)
                    .build());
            ...
            builder.option(Option.<Integer>createBuilder()
                    ...
                    .binding(60, () -> ClientConfig.getInt("watheextended.medicalKit.cooldown", 60), value -> stage(sendCommand, parent, "watheextended.medicalKit.cooldown", value))
                    .controller(IntegerFieldControllerBuilder::create)
                    .build());
            ...
            builder.option(Option.<Integer>createBuilder()
                    ...
                    .binding(250, () -> ClientConfig.getInt("watheextended.pan.price", 250), value -> stage(sendCommand, parent, "watheextended.pan.price", value))
                    .controller(IntegerFieldControllerBuilder::create)
                    .build());
            /// COOLDOWN
            builder.option(Option.<Integer>createBuilder()
                    ...
                    .binding(45, () -> ClientConfig.getInt("watheextended.pan.cooldown", 45), value -> stage(sendCommand, parent, "watheextended.pan.cooldown", value))
                    .controller(IntegerFieldControllerBuilder::create)
                    .build());
            ...
            builder.option(Option.<Integer>createBuilder()
                    ...
                    .binding(125, () -> ClientConfig.getInt("watheextended.poisonInjector.price", 125), value -> stage(sendCommand, parent, "watheextended.poisonInjector.price", value))
                    .controller(IntegerFieldControllerBuilder::create)
                    .build());
            /// COOLDOWN
            builder.option(Option.<Integer>createBuilder()
                    ...
                    .binding(60, () -> ClientConfig.getInt("watheextended.poisonInjector.cooldown", 60), value -> stage(sendCommand, parent, "watheextended.poisonInjector.cooldown", value))
                    .controller(IntegerFieldControllerBuilder::create)
                    .build());
            ...
            builder.option(Option.<Integer>createBuilder()
                    ...
                    .binding(300, () -> ClientConfig.getInt("watheextended.pill.price", 300), value -> stage(sendCommand, parent, "watheextended.pill.price", value))
                    .controller(IntegerFieldControllerBuilder::create)
                    .build());
            /// COOLDOWN
            builder.option(Option.<Integer>createBuilder()
                    ...
                    .binding(180, () -> ClientConfig.getInt("watheextended.pill.cooldown", 180), value -> stage(sendCommand, parent, "watheextended.pill.cooldown", value))
                    .controller(IntegerFieldControllerBuilder::create)
                    .build());
            ...
            builder.option(Option.<Integer>createBuilder()
                    ...
                    .binding(175, () -> ClientConfig.getInt("watheextended.blowgun.price", 175), value -> stage(sendCommand, parent, "watheextended.blowgun.price", value))
                    .controller(IntegerFieldControllerBuilder::create)
                    .build());
            /// COOLDOWN
            builder.option(Option.<Integer>createBuilder()
                    ...
                    .binding(60, () -> ClientConfig.getInt("watheextended.blowgun.cooldown", 60), value -> stage(sendCommand, parent, "watheextended.blowgun.cooldown", value))
                    .controller(IntegerFieldControllerBuilder::create)
                    .build());
            ...
            builder.option(Option.<Integer>createBuilder()
                    ...
                    .binding(75, () -> ClientConfig.getInt("watheextended.knockoutDrug.price", 75), value -> stage(sendCommand, parent, "watheextended.knockoutDrug.price", value))
                    .controller(IntegerFieldControllerBuilder::create)
                    .build());
            /// COOLDOWN
            builder.option(Option.<Integer>createBuilder()
                    ...
                    .binding(60, () -> ClientConfig.getInt("watheextended.knockoutDrug.cooldown", 60), value -> stage(sendCommand, parent, "watheextended.knockoutDrug.cooldown", value))
                    .controller(IntegerFieldControllerBuilder::create)
                    .build());
        }
    ...
    private static void stage(BiConsumer<String, Screen> command, Screen parent, String key, Object value) {
