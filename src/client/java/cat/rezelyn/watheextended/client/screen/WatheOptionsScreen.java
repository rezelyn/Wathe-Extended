...
public final class WatheOptionsScreen {
    ...
    public static Screen create(Screen parent) {
        ...
        YetAnotherConfigLib.Builder builder = YetAnotherConfigLib.createBuilder()
                ...
                .category(ClientCategory.build(parent, op, WatheOptionsScreen::stageCommand))
                .save(WatheOptionsScreen::flushPendingChanges);

        if (op) {
            builder.category(OptionsCategory.build(parent, WatheOptionsScreen::stageCommand));
            builder.category(MapVariablesCategory.build(parent, WatheOptionsScreen::stageCommand));
            builder.category(RolesCategory.build(parent, BLACKLIST, pendingRoleState, WatheOptionsScreen::stageCommand));
            builder.category(ModifiersCategory.build(parent, pendingModifierState, WatheOptionsScreen::stageCommand));
        }
