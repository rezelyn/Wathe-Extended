        ...
        switch (id) {
            ...
            case "kinswathe:bellringer" -> {
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(200, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getBellringerAbilityPrice(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.BellringerAbilityPrice", value))
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(120, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getBellringerAbilityCooldown(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.BellringerAbilityCooldown", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
            }
            // Bodymaker
            case "kinswathe:bodymaker" -> {
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(90, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getBodymakerAbilityCooldown(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.BodymakerAbilityCooldown", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                ...
                builder.option(Option.<Boolean>createBuilder()
                        ...
                        .binding(true, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getBodymakerAbilityFakeRole(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.BodymakerAbilityFakeRole", value))
            ...
            case "kinswathe:cleaner" -> {
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(200, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getCleanerAbilityPrice(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.CleanerAbilityPrice", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                /// ABILITY - COOLDOWN
                builder.option(Option.<Integer>createBuilder()
                        .name(Text.translatable("gui.watheextended.config.text.cooldown"))
                        .description(OptionDescription.of(Text.translatable("gui.watheextended.config.category.roles.opt.cleaner.cooldown.desc")))
                        .binding(150, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getCleanerAbilityCooldown(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.CleanerAbilityCooldown", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
            ...
            case "kinswathe:detective" -> {
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(200, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getDetectiveAbilityPrice(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.DetectiveAbilityPrice", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                /// ABILITY - COOLDOWN
                builder.option(Option.<Integer>createBuilder()
                        .name(Text.translatable("gui.watheextended.config.text.cooldown"))
                        .description(OptionDescription.of(Text.translatable("gui.watheextended.config.category.roles.opt.detective.cooldown.desc")))
                        .binding(90, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getDetectiveAbilityCooldown(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.DetectiveAbilityCooldown", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
            }
            // Dreamer
            case "kinswathe:dreamer" -> {
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(1, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getDreamerInitialItemQuantity(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.DreamerInitialItemQuantity", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
            }
            // Drugmaker
            case "kinswathe:drugmaker" -> {
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(10, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getDrugmakerPlayerLimit(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.DrugmakerPlayerLimit", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                /// POISON KILL INCOME
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(50, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getDrugmakerGetCoins(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.DrugmakerGetCoins", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
            }
            // Hacker
            case "kinswathe:hacker" -> {
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(10, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getHackerPlayerLimit(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.HackerPlayerLimit", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                /// GENERATE WITH MIMIC
                builder.option(Option.<Boolean>createBuilder()
                        ...
                        .binding(false, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getHackerGenerateWithMimic(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.HackerGenerateWithMimic", value))
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(30, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getHackerHackingTime(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.HackerHackingTime", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                /// HAS SHOP
                builder.option(Option.<Boolean>createBuilder()
                        ...
                        .binding(true, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getHackerHasShop(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.HackerHasShop", value))
            ...
            case "kinswathe:hunter" -> {
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(125, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getHunterAbilityPrice(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.HunterAbilityPrice", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                /// ABILITY - COOLDOWN
                builder.option(Option.<Integer>createBuilder()
                        .name(Text.translatable("gui.watheextended.config.text.cooldown"))
                        .description(OptionDescription.of(Text.translatable("gui.watheextended.config.category.roles.opt.hunter.cooldown.desc")))
                        .binding(5, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getHunterAbilityCooldown(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.HunterAbilityCooldown", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
            }
            // Judge
            case "kinswathe:judge" -> {
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(300, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getJudgeAbilityPrice(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.JudgeAbilityPrice", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                /// ABILITY - COOLDOWN
                builder.option(Option.<Integer>createBuilder()
                        .name(Text.translatable("gui.watheextended.config.text.cooldown"))
                        .description(OptionDescription.of(Text.translatable("gui.watheextended.config.category.roles.opt.judge.cooldown.desc")))
                        .binding(180, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getJudgeAbilityCooldown(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.JudgeAbilityCooldown", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                /// ABILITY - DURATION
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(90, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getJudgeAbilityGlowing(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.JudgeAbilityGlowing", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
            }
            // Licensed Villian
            case "kinswathe:licensed_villain" -> {
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(10, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getLicensedVillainPlayerLimit(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.LicensedVillainPlayerLimit", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
            }
            // Robot
            case "kinswathe:robot" -> {
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(90, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getRobotAbilityCooldown(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.RobotAbilityCooldown", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                /// ABILITY - DURATION
                builder.option(Option.<Integer>createBuilder()
                        .name(Text.translatable("gui.watheextended.config.text.duration"))
                        .description(OptionDescription.of(Text.translatable("gui.watheextended.config.category.roles.opt.robot.duration.desc")))
                        .binding(10, () -> cat.rezelyn.watheextended.api.kinswathe.ConfigHelper.getRobotAbilityDuration(MinecraftClient.getInstance().world), value -> ScreenUtils.stage(sendCommand, parent, "kinswathe.RobotAbilityDuration", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
            }
            // Voodoo
            case "noellesroles:voodoo" -> {
                ...
                builder.option(Option.<Boolean>createBuilder()
                        ...
                        .binding(true, cat.rezelyn.watheextended.api.noellesroles.ConfigHelper::getVoodooShotLikeEvil, value -> ScreenUtils.stage(sendCommand, parent, "noellesroles.voodooShotLikeEvil", value))
                ...
                builder.option(Option.<Boolean>createBuilder()
                        ...
                        .binding(false, cat.rezelyn.watheextended.api.noellesroles.ConfigHelper::getVoodooNonKillerDeaths, value -> ScreenUtils.stage(sendCommand, parent, "noellesroles.voodooNonKillerDeaths", value))
                        .controller(option -> BooleanControllerBuilder.create(option).coloured(true).formatValue(value -> Text.translatable(value ? "gui.watheextended.config.text.enabled" : "gui.watheextended.config.text.disabled"))).build());
            }
            // Conductor
            case "noellesroles:conductor" -> {
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(10, cat.rezelyn.watheextended.api.noellesroles.ConfigHelper::getPlayerCountToMakeConducterKeyVisible, value -> ScreenUtils.stage(sendCommand, parent, "noellesroles.playerCountToMakeConducterKeyVisible", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
            }
            // Bartender
            case "noellesroles:bartender" -> {
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(1, cat.rezelyn.watheextended.api.noellesroles.ConfigHelper::getMaximumDefenseVials, value -> ScreenUtils.stage(sendCommand, parent, "noellesroles.maximumDefenseVials", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
            }
            // Necromancer
            case "stupid_express:necromancer" -> {
                ...
                builder.option(Option.<Boolean>createBuilder()
                        ...
                        .binding(false, cat.rezelyn.watheextended.api.stupidexpress.ConfigHelper::getNecromancerHasShop, value -> ScreenUtils.stage(sendCommand, parent, "stupidexpress.necromancerHasShop", value))
                        .controller(option -> BooleanControllerBuilder.create(option).coloured(true).formatValue(value -> Text.translatable(value ? "gui.watheextended.config.text.enabled" : "gui.watheextended.config.text.disabled"))).build());
            }
            // Arsonist
            case "stupid_express:arsonist" -> {
                ...
                builder.option(Option.<Boolean>createBuilder()
                        ...
                        .binding(true, cat.rezelyn.watheextended.api.stupidexpress.ConfigHelper::getArsonistKeepsGameGoing, value -> ScreenUtils.stage(sendCommand, parent, "stupidexpress.arsonistKeepsGameGoing", value))
                        .controller(option -> BooleanControllerBuilder.create(option).coloured(true).formatValue(value -> Text.translatable(value ? "gui.watheextended.config.text.enabled" : "gui.watheextended.config.text.disabled"))).build());
            }
            // Amnesiac
            case "stupid_express:amnesiac" -> {
                ...
                builder.option(Option.<Boolean>createBuilder()
                        ...
                        .binding(true, cat.rezelyn.watheextended.api.stupidexpress.ConfigHelper::getBodiesGlowToAmnesiac, value -> ScreenUtils.stage(sendCommand, parent, "stupidexpress.bodiesGlowToAmnesiac", value))
                        .controller(option -> BooleanControllerBuilder.create(option).coloured(true).formatValue(value -> Text.translatable(value ? "gui.watheextended.config.text.enabled" : "gui.watheextended.config.text.disabled"))).build());
                /// GLOWS DIFFERENTLY
                builder.option(Option.<Boolean>createBuilder()
                        ...
                        .binding(false, cat.rezelyn.watheextended.api.stupidexpress.ConfigHelper::getAmnesiacGlowsDifferently, value -> ScreenUtils.stage(sendCommand, parent, "stupidexpress.amnesiacGlowsDifferently", value))
                        .controller(option -> BooleanControllerBuilder.create(option).coloured(true).formatValue(value -> Text.translatable(value ? "gui.watheextended.config.text.enabled" : "gui.watheextended.config.text.disabled"))).build());
            }
            // Starstruck
            case "starexpress:starstruck" -> {
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(90, cat.rezelyn.watheextended.api.starexpress.ConfigHelper::getStarstruckAbilityCooldown, value -> ScreenUtils.stage(sendCommand, parent, "starexpress.abilityCooldown", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                /// ABILITY - DURATION
                builder.option(Option.<Integer>createBuilder()
                        .name(Text.translatable("gui.watheextended.config.text.duration"))
                        .description(OptionDescription.of(Text.translatable("gui.watheextended.config.category.roles.opt.starstruck.duration.desc")))
                        .binding(15, cat.rezelyn.watheextended.api.starexpress.ConfigHelper::getStarstruckAbilityDuration, value -> ScreenUtils.stage(sendCommand, parent, "starexpress.abilityDuration", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                ...
                builder.option(Option.<Boolean>createBuilder()
                        ...
                        .binding(true, cat.rezelyn.watheextended.api.starexpress.ConfigHelper::getStarstruckTaskReducesCooldown, value -> ScreenUtils.stage(sendCommand, parent, "starexpress.taskReducesCooldown", value))
                        .controller(option -> BooleanControllerBuilder.create(option).coloured(true).formatValue(value -> Text.translatable(value ? "gui.watheextended.config.text.enabled" : "gui.watheextended.config.text.disabled"))).build());
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(5, cat.rezelyn.watheextended.api.starexpress.ConfigHelper::getStarstruckTaskCooldownReduction, value -> ScreenUtils.stage(sendCommand, parent, "starexpress.taskCooldownReduction", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                ...
                builder.option(Option.<Boolean>createBuilder()
                        ...
                        .binding(true, cat.rezelyn.watheextended.api.starexpress.ConfigHelper::getStarstruckAbilityAffectsMovementSpeed, value -> ScreenUtils.stage(sendCommand, parent, "starexpress.abilityAffectsMovementSpeed", value))
                        .controller(option -> BooleanControllerBuilder.create(option).coloured(true).formatValue(value -> Text.translatable(value ? "gui.watheextended.config.text.enabled" : "gui.watheextended.config.text.disabled"))).build());
                /// ABILITY - WALK SPEED
                builder.option(Option.<Float>createBuilder()
                        ...
                        .binding(0.12f, cat.rezelyn.watheextended.api.starexpress.ConfigHelper::getStarstruckAbilityWalkSpeed, value -> ScreenUtils.stage(sendCommand, parent, "starexpress.abilityWalkSpeed", value))
                ...
                builder.option(Option.<Float>createBuilder()
                        ...
                        .binding(0.15f, cat.rezelyn.watheextended.api.starexpress.ConfigHelper::getStarstruckAbilitySprintSpeed, value -> ScreenUtils.stage(sendCommand, parent, "starexpress.abilitySprintSpeed", value))
                        .controller(ScreenUtils::floatController).build());
            }
            // Muzzler
            case "starexpress:muzzler" -> {
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(20, cat.rezelyn.watheextended.api.starexpress.ConfigHelper::getMuzzlerTapeCooldown, value -> ScreenUtils.stage(sendCommand, parent, "starexpress.tapeCooldown", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(60, cat.rezelyn.watheextended.api.starexpress.ConfigHelper::getMuzzlerSuffocationTime, value -> ScreenUtils.stage(sendCommand, parent, "starexpress.suffocationTime", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(5, cat.rezelyn.watheextended.api.starexpress.ConfigHelper::getMuzzlerTapeTearCheckCount, value -> ScreenUtils.stage(sendCommand, parent, "starexpress.tapeTearCheckCount", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
                ...
                builder.option(Option.<Float>createBuilder()
                        ...
                        .binding(0.1f, cat.rezelyn.watheextended.api.starexpress.ConfigHelper::getMuzzlerTapeTearMoodChange, value -> ScreenUtils.stage(sendCommand, parent, "starexpress.tapeTearMoodChange", value))
                        .controller(ScreenUtils::floatController).build());
                ...
                builder.option(Option.<Boolean>createBuilder()
                        ...
                        .binding(true, cat.rezelyn.watheextended.api.starexpress.ConfigHelper::getMuzzlerKillIfCheckedAtZero, value -> ScreenUtils.stage(sendCommand, parent, "starexpress.killIfCheckedAtZero", value))
                        .controller(option -> BooleanControllerBuilder.create(option).coloured(true).formatValue(value -> Text.translatable(value ? "gui.watheextended.config.text.enabled" : "gui.watheextended.config.text.disabled"))).build());
                ...
                builder.option(Option.<Integer>createBuilder()
                        ...
                        .binding(120, cat.rezelyn.watheextended.api.starexpress.ConfigHelper::getMuzzlerDisplaySilencedTipDelay, value -> ScreenUtils.stage(sendCommand, parent, "starexpress.displaySilencedTipDelay", value))
                        .controller(IntegerFieldControllerBuilder::create).build());
            }
        }
    }
