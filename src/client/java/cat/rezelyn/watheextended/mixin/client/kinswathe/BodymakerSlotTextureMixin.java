...
@Mixin(targets = "org.BsXinQin.kinswathe.client.roles.bodymaker.BodymakerPlayerWidget", remap = false)
public abstract class BodymakerSlotTextureMixin {
    ...
    private void watheextended$overrideBodymakerSlotTexture(DrawContext context, Identifier texture, int x, int y, int width, int height) {
